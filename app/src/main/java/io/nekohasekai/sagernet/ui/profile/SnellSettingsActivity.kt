...
class SnellSettingsActivity : ProfileSettingsActivity<SnellBean>() {
    ...
    override fun PreferenceFragmentCompat.createPreferences(
        ...
        psk.preference.apply {
            this as EditTextPreference
            summaryProvider = PasswordSummaryProvider
        }

        val userKeyPref = userKey.preference as EditTextPreference
        userKeyPref.summaryProvider = PasswordSummaryProvider

        val versionPref = version.preference as SimpleMenuPreference
        val networkPref = network.preference as SimpleMenuPreference
        val reusePref = reuse.preference
